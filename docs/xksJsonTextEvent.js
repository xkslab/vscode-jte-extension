 ...
 * 
 * @param recourses
 * @text デプロイメントに含めるリソース
 * @type struct<Recourse>
 * @desc 「未使用ファイルを除外する」で除外されないようにします。プラグインで使用したファイルを全て指定してください。
 * 
 * @help
 ...
 * 
 * ※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※
 * ※ デプロイ前に必ずプラグインパラメータの『デプロイメントに含めるリソース』を設定してください ※
 * ※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※※
 * 
 * 【コマンドリストの構造】
 ...
 * @dir img/pictures
 * @default []
 * @desc プラグインで使用したピクチャファイルを全て指定してください。
 * 
 * @param img/faces
 * @text 顔グラフィックパス
 * @type file[]
 * @dir img/faces
 * @default []
 * @desc プラグインで使用した顔グラフィックファイルを全て指定してください。
 * 
 */
