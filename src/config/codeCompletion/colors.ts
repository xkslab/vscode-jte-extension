...
const defaultColorMappping: ColorMapping = {
 ...
 */
export function setupColorMapping(userConfig: JteConfig | null): ColorMapping {
    ...
    const combined = {...defaultColorMappping, ...userConfig.codeCompletion.colors};
    return combined;
}