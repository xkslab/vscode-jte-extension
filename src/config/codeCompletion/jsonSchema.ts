...
export interface JsonSchema {
    default: JsonSchemaItem;
    [key: string]: JsonSchemaItem;
}

export interface JsonSchemaItem {
    properties: JsonSchemaProperty[];
    values?: Record<string, JsonSchemaValue[]>;
}
 ...
 */
export function setupJsonSchema(userConfig: JteConfig | null): JsonSchema {
    ...
    return deepMerge(JSON.parse(JSON.stringify(defaultJsonSchema)), userConfig.codeCompletion.json);
}
